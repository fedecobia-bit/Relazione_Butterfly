...
\noindent A causa dell'aritmetica con punto fisso utilizzata nella FFT, alcuni campioni che dovrebbero essere zero hanno valori molto piccoli.
...
Infine, dalle figure sottostanti si può notare che i campioni che escono dal blocco FFT iniziano a stabilizzarsi prima che
...
Qualsiasi valore presente alle uscite prima dell'asserimento di DONE non deve essere utilizzato poiché potrebbero essere
