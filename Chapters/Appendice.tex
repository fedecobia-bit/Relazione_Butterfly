...
\subsection{Registri}
\subsubsection{Flip Flop di tipo D}

\lstinputlisting[
  language=VHDL,
  caption={Flip Flop di tipo D}
]{Code/Components/fd.vhd}

\subsubsection{Flip Flop di tipo T}

\lstinputlisting[
  language=VHDL,
  caption={Flip Flop di tipo T}
]{Code/Components/t_ff.vhd}


\subsection{MUX}

\subsubsection{MUX a due ingressi}

\lstinputlisting[
  language=VHDL,
  caption={MUX a due ingressi}
]{Code/Components/mux_2.vhd}

\subsubsection{MUX a tre ingressi}

\lstinputlisting[
  language=VHDL,
  caption={MUX a tre ingressi}
...
\subsection{Datapath Butterfly}

\lstinputlisting[
  language=VHDL,
  caption={Datapath Butterfly}
]{Code/Components/bfly_datapath.vhd}

\subsection{Control Unit}

\subsubsection{Datapath Control Unit}
...
\subsubsection{ROM Control unit}
...
\lstinputlisting[
  language=VHDL,
  caption={Control Unit Late Status PLA}
...
\lstinputlisting[
  language=VHDL,
  caption={Test Bench della Butterfly singola}
]{Code/Test Bench/tb_bfly_single.vhd}

\subsubsection{Test Bench della FFT 16x16}
