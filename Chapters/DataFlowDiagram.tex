...
Il blocco moltiplicatore è stato rappresentato in \ref{fig: blockfdataflowdiagram} con il blocco \(verde\) e mentre l'operazione di shift è stata rappresentata con il blocco \(viola\).
