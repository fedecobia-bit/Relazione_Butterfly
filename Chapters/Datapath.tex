...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Foto/Datapath/datapath_originale.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Foto/Datapath/datapath.jpg}
...
Questa tecnica consiste nell'arrotondare gli N bit in ingresso al blocco arrotondatore con una look-up-table salvata all'interno
di una memoria ROM.
...
ma permette un arrotondamento peggiore.
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        \hline
        bit indirizzo  & righe ROM & bit totali (singola butterfly) & bit totali (FFT)   \\ \hline
            3          &     8     &            24                  &       768             \\ \hline
            4          &    14     &            56                  &       1792             \\ \hline
            5          &    32     &            160                 &       5120             \\ \hline
            6          &    64     &            384                 &      12288              \\ \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|}
        \hline
            ...
            5 (2 Mantissa + 3 Scarto)  &  -1/16   &   -4     \\ \hline
            5 (3 Mantissa + 2 Scarto)  &   1/16   &   -1     \\ \hline
            6 (3 Mantissa + 3 Scarto)  &    0     &   -4     \\ \hline
    \end{tabular}
...
Il numero totale di bit che compongono l'indirizzo è quindi 5.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Foto/Datapath/ROM_rounding.jpg}
